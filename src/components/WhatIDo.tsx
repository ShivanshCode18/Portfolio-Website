        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <p>
                Building end-to-end data pipelines, predictive analytics systems,
                and ML models to derive actionable insights from complex datasets.
              </p>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <p>
                Designing scalable cloud infrastructure, ETL pipelines, and
                automated workflows using AWS, Azure, and modern data tools.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
